...
```powershell
irm https://raw.githubusercontent.com/LFroesch/dwight/main/install.ps1 | iex
```

Direct installers: [`install.sh`](https://raw.githubusercontent.com/LFroesch/dwight/main/install.sh), [`install.ps1`](https://raw.githubusercontent.com/LFroesch/dwight/main/install.ps1)
